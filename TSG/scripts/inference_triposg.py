...
if __name__ == "__main__":
    ...
    parser.add_argument("--triposg-weights-dir", type=str, default="pretrained_weights/TripoSG")
    parser.add_argument("--rmbg-weights-dir", type=str, default="pretrained_weights/RMBG-1.4")
    ...
    if not os.path.exists(triposg_weights_dir):
        raise FileNotFoundError(f"TripoSG weights not found at: {triposg_weights_dir}")
    if not os.path.exists(rmbg_weights_dir):
        raise FileNotFoundError(f"RMBG weights not found at: {rmbg_weights_dir}")
